...
return (
    ...
    <div
        id="contact"
        className="contact-content grid gap-6 px-4 py-10 bg-[#242424] rounded-lg text-white shadow-lg md:grid-cols-2"
    >
    ...
    <ContactCards
        ...
        <div className="flex flex-col items-center justify-center h-full gap-4 px-4 text-center">
            ...
            <p className="text-gray-300">
            Use the form or find me on LinkedIn and GitHub. Let’s build
